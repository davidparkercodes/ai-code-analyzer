...
impl MetricsReporter {
    ...
    fn print_production_metrics(&self, metrics: &CodeMetrics) {
        // Production metrics
        let labels = ["Files:", "Lines of Code:", "Blank Lines:", "Comment Lines:"];
    ...
    fn print_language_breakdown(
        &self,
        language_map: &std::collections::HashMap<String, crate::metrics::models::LanguageMetrics>,
    ) {
        ...
        // Print header
        let header = format!(
            "{:<lang_width$}{:>files_width$}{:>loc_width$}",
            language_header,
            files_header,
            loc_header,
